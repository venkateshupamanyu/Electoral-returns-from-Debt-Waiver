...
*import excel using "...\GE\Details Of Assembly Segments Of PC-pages-1-1508_1-compressed-compressed_compressed (1).xlsx",sheet(Sheet1 (2)) 
...
import delimited "...\GE\2009 data 3.txt", delimiter(tab, collapse)
