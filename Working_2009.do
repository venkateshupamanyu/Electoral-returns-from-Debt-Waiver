...
*** - re-arrange 66 rows in last column ***

*import excel using "C:\Users\venka\Box\Personal\Tufts PhD\Research work\Debt waiver and electoral performance\GE\Details Of Assembly Segments Of PC-pages-1-1508_1-compressed-compressed_compressed (1).xlsx",sheet(Sheet1 (2)) 
...
*** We imported the 2009 data 3.txt and then used tab delimited option ***

import delimited "C:\Users\venka\Box\Personal\Tufts PhD\Research work\Debt waiver and electoral performance\GE\2009 data 3.txt", delimiter(tab, collapse)
...
*** Dropping blank rows ***
count if v1=="" & v2=="" & v3=="" & v4==.
drop if v1=="" & v2=="" & v3=="" & v4==.

*** State ***
count if v1=="State-UT Code & Name :"
tab v2 if v1=="State-UT Code & Name :"
gen state=v2 if v1=="State-UT Code & Name :"
tab state
replace state=state[_n-1] if state==""
*** PC ***
count if v1=="PC No. & Name :"
tab v2 if v1=="PC No. & Name :"
gen pc=v2 if v1=="PC No. & Name :"
tab pc

*** AC ***
count if v1=="AC Number and AC Name :"
tab v2 if v1=="AC Number and AC Name :"
gen ac=v2 if v1=="AC Number and AC Name :"
tab ac
count if v1=="Total Valid Votes for the AC :"
tab v2 if v1=="Total Valid Votes for the AC :"

count if v1=="Valid Postal Ballots for each candidate in the PC"
count if v2=="Valid Postal Ballots for each candidate in the PC"

replace ac=v1 if v1=="Valid Postal Ballots for each candidate in the PC"
replace ac=v2 if v2=="Valid Postal Ballots for each candidate in the PC"

drop if v1=="PC No. & Name :"
replace ac=ac[_n-1] if ac==""
drop if ac=="Valid Postal Ballots for each candidate in the PC"

count if v1=="Total Valid Votes for the AC :"
count if v2=="Total Valid Votes for the AC :"
tab id if v2=="Total Valid Votes for the AC :"
tab state if v2=="Total Valid Votes for the AC :"


*** Candidate ***
tab v1 if v1!="State-UT Code & Name :" & v1!="PC No. & Name" & v1!="AC Number and AC Name" & v1!="Total Valid Votes for the AC :" & v1!="Valid Postal Ballots for each candidate in the PC"

count if v1!="" & v4==.
tab v1 if v4==.
count if v1!="" & v2!="" & v3!="" & v4==. & ///
				v1!="Total Valid Postal Ballots for the PC" & ///
				v1!="Total Valid Votes for the PC:" & ///
				v1!="PC No. & Name :" & ///
				v1!="AC Number and AC Name :" & ///
				v1!="Total Valid Votes for the AC :" & ///
				v1!="Valid Postal Ballots for each candidate in the PC" & ///
				v1!="Total Valid Votes for the State/UT:" 
gen cand=v1 if v1!="" & v2!="" & v3!="" & v4==. & ///
				v1!="Total Valid Postal Ballots for the PC" & ///
				v1!="Total Valid Votes for the PC:" & ///
				v1!="PC No. & Name :" & ///
				v1!="AC Number and AC Name :" & ///
				...
				v1!="Valid Postal Ballots for each candidate in the PC" & ///
				v1!="Total Valid Votes for the State/UT:"
replace cand=v2 if v2!="" & v1=="" & v3!="" & v4!=.
count if v1=="Total Valid Votes for the AC :"
tab state if v1=="Total Valid Votes for the AC :"
tab state if v2=="Total Valid Votes for the AC :"
tab id if v2=="Total Valid Votes for the AC :"
drop if v1=="Total Valid Votes for the AC :"
drop if v2=="Total Valid Votes for the AC :"
...
forvalues i=1(1)43 {
replace cand=v2 if v1=="`i'"
}

count if v1=="AC Number and AC Name :"
tab state if v1=="AC Number and AC Name :"
tab state if v2=="AC Number and AC Name :"
tab state if v3=="AC Number and AC Name :"
drop if v1=="AC Number and AC Name :"
...
tab id if v1=="State-UT Code & Name :"
tab v2 if v1=="State-UT Code & Name :"
tab v2 if v1=="State-UT Code & Name :" & v3=="" & v4==.
drop if v1=="State-UT Code & Name :" & v3=="" & v4==.

replace pc=pc[_n-1] if pc==""
replace ac=ac[_n-1] if ac=="" & ac[_n-1]!=""
...
*** Party ***
tab v2 if v2!="" & cand!="" & v1!="" & v4==.
gen party=v2 if v2!="" & cand!="" & v1!="" & v4==.
tab v3 if v3!="" & v4!=. & v1=="" & cand!=""
replace party=v3 if v3!="" & v4!=. & v1=="" & cand!=""
tab party
tab state if party==""
tab id if party==""
tab v3 if cand!="" & party=="" & v2!="" & v1!=""
tab v1 if cand!="" & party=="" & v2!="" & v1!=""
tab v3 if cand!="" & party=="" & v2!="" & v1!="" & v4!=.
replace party=v3 if cand!="" & party=="" & v2!="" & v1!="" & v4!=.
count if party==""

*** Votes ***
tab v3 if v1!="" & v2!="" & v3!="" & v4==.
gen votes=v3 if v1!="" & v2!="" & v3!="" & v4==.
tab v4 if votes=="" & v2!="" & v3!="" & v4!=.
tab state if votes=="" & v2!="" & v3!="" & v4!=.
tostring v4,replace
replace votes=v4 if votes=="" & v2!="" & v3!="" & v4!=""
count if votes==""


save "C:\Users\venka\Box\Personal\Tufts PhD\Research work\Debt waiver and electoral performance\GE\2009-PC-AC temp.dta"

destring votes,replace
sort state pc ac 
by state pc ac: egen acvotes=sum(votes)
by state pc:egen pcvotes=sum(votes)
...
tab var1
count if var1=="State-UT Code & Name :"
...
tab var2 if var1=="State-UT Code & Name :"
gen state=var2 if var1=="State-UT Code & Name :"
tab var2 if var1=="PC No. & Name :"
gen pc=var2 if var1=="PC No. & Name :"
tab var2 if var1=="AC Number and AC Name :"
tab var2 if (var1=="AC Number and AC Name :" | var1=="Valid Postal Ballots for each candidate in the PC")


gen ac=var2 if var1=="AC Number and AC Name :"
replace ac=var1 if var1=="Valid Postal Ballots for each candidate in the PC"

count if var1=="" & var2=="" & var3=="" & var4=="" & var5==.
...
count if var1=="State-UT Code & Name :"
drop if var1=="State-UT Code & Name :"

count if var1=="PC No. & Name :"
drop if var1=="PC No. & Name :"
...
gen cand=var1 if var1!="AC Number and AC Name :"
replace cand=var2 if cand=="" & var1==""
count if var2!="" & cand=="" & var1==""
count if cand=="" & var1==""
count if var2=="" & cand=="" & var1==""
tab id if var2=="" & cand=="" & var1==""

count if cand=="1"
tab var2 if cand=="1"
replace cand=var2 if cand=="1"
count if cand=="1"
count if cand=="44"
count if cand=="43"
count if cand==""
...
forvalues i == 2(1)43 {
replace cand=var2 if cand=="`i'"
}

tostring var5,replace

count if var2!="" & var3!="" & var4=="" & var5=="."
tab var2 if var3!="" & var4=="" & var5=="."
gen party=var2 if var2!="" & var3!="" & var4=="" & var5=="."
count if var3!="" & var4!="" & var2=="" & var5=="."
replace party=var3 if var3!="" & var4!="" & var2=="" & var5=="."
replace party=var3 if var3!="" & var4!="" & var1=="" & var5=="."
replace party=var3 if party=="" & var3!="" & var4!="" & var5=="."
count if var4!="" & var5!="" & var3=="" 
replace party=var4 if var5!="" & var3==""

gen votes=var3 if var2!="" & var3!="" & var4=="" & var5=="."
replace votes=var3 if var4=="" & var5=="."
replace votes=var5 if var3=="" & var1==""
replace votes=var5 if var3==""
replace votes=var4 if var5=="." & var2==""
replace votes=var4 if var5=="." 

count if cand!="" & party=="" & votes=="" & var2==""
count if cand!="" & party=="" & votes=="" & var2=="" & cand!="Valid Postal Ballots for each candidate in the PC"

tab cand if party=="" & votes=="" & var2=="" & cand!="Valid Postal Ballots for each candidate in the PC"
drop if cand!="" & party=="" & votes=="" & var2=="" & cand!="Valid Postal Ballots for each candidate in the PC"

count if party==""
count if votes==""
count if party=="" & votes!=""
tab id if party=="" & votes!=""
...
count if var2!="" & var1==""
replace var1=var2 if var2!="" & var1==""

egen var6=concat(var1 var2) if var1=="1"
replace var1=var6 if var1=="1"
drop var6

forvalues i=2 3 {
egen var`i'_1=concat(var1 var2) if var1="`i'"
replace var1=var`i'_1 if var1=="`i'"
drop var`i'_1
}
...
count if var1==var2
replace var2="" if var1==var2

count if var2=="" & var3!=""
tab var3 if var2=="" 

count if var1!="" & var2=="" & var3=="" & var4=="" & var5==.
count if var1!="" & var2=="" & var3=="" & var4=="" & var4=="" & var5==. & var1!="Valid Postal Ballots for each candidate in the PC"

tab var1 if var2=="" & var3=="" & var4=="" & var5==.
tab var1 if var2=="" & var3=="" & var4=="" & var5==. & var1!="Valid Postal Ballots for each candidate in the PC"
drop if var2=="" & var3=="" & var4=="" & var5==. & var1!="Valid Postal Ballots for each candidate in the PC"
...
save "C:\Users\venka\Box\Personal\Tufts PhD\Research work\Debt waiver and electoral performance\GE\2004-PC-AC temp.dta", replace

clear

use "C:\Users\venka\Box\Personal\Tufts PhD\Research work\Debt waiver and electoral performance\GE\2004-PC-AC temp_1.dta"
...
save "C:\Users\venka\Box\Personal\Tufts PhD\Research work\Debt waiver and electoral performance\GE\2004-PC-AC temp_2.dta",replace
